...
namespace SpriteKind {
    ...
    export const Goal7 = SpriteKind.create()
    ...
    export const Goal8 = SpriteKind.create()
    export const Projectile5 = SpriteKind.create()
    export const Projectile6 = SpriteKind.create()
    export const Fake1 = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.Projectile5, function (sprite, otherSprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Fake1, function (sprite, otherSprite) {
    tiles.placeOnTile(Ploger, tiles.getTileLocation(3, 1))
    sprite.sayText("That orb didn't look right...", 5000, true)
    tiles.placeOnTile(cosmicClone1, tiles.getTileLocation(1, 9))
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Goal7, function (sprite, otherSprite) {
    tiles.setCurrentTilemap(tilemap`level25`)
    sprites.destroy(Orb7)
    sprites.destroy(Fire3)
    sprites.destroy(Key2)
    sprites.destroy(Key3)
    sprites.destroy(Key4)
    Key5 = sprites.create(assets.image`Key1`, SpriteKind.Projectile5)
    FakeOrb1 = sprites.create(assets.image`fakeOrb`, SpriteKind.Fake1)
    cosmicClone1 = sprites.create(assets.image`cosmicClone`, SpriteKind.clone1)
    cosmicClone1.follow(Ploger, 35)
    cosmicClone1.setFlag(SpriteFlag.GhostThroughWalls, true)
    Orb8 = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . 6 6 6 6 . . . . . . 
        . . . . 6 6 6 5 5 6 6 6 . . . . 
        . . . 7 7 7 7 6 6 6 6 6 6 . . . 
    ...
    tiles.placeOnTile(Ploger, tiles.getTileLocation(3, 1))
    tiles.placeOnTile(cosmicClone1, tiles.getTileLocation(1, 9))
    tiles.placeOnTile(Orb8, tiles.getTileLocation(1, 27))
    tiles.placeOnTile(Key5, tiles.getTileLocation(1, 9))
    tiles.placeOnTile(FakeOrb1, tiles.getTileLocation(38, 38))
    scene.cameraShake(10, 500)
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.clone1, function (sprite, otherSprite) {
    tiles.placeOnTile(Ploger, tiles.getTileLocation(3, 1))
    tiles.placeOnTile(cosmicClone1, tiles.getTileLocation(1, 9))
    sprites.destroy(Key5)
    Key5 = sprites.create(assets.image`Key1`, SpriteKind.Projectile5)
    tiles.placeOnTile(Key5, tiles.getTileLocation(1, 9))
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Goal8, function (sprite, otherSprite) {
    game.gameOver(true)
    game.setGameOverMessage(true, "More levels coming soon!")
})
scene.onOverlapTile(SpriteKind.Projectile5, assets.tile`yellowKeyhole`, function (sprite, location) {
    sprites.destroy(Key5)
})
...
let Orb8: Sprite = null
let FakeOrb1: Sprite = null
let Key5: Sprite = null
